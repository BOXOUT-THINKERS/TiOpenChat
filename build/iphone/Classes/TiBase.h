...
// in simulator we redefine to format for TiOpenChat Developer console
...
{\
	NSString * exceptionName = [@"org.tiopenchat." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tiopenchat";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITiOpenChatNativeItemNone = -1, 
	UITiOpenChatNativeItemSpinner = -2,
	UITiOpenChatNativeItemProgressBar = -3,
	
	UITiOpenChatNativeItemSlider = -4,
	UITiOpenChatNativeItemSwitch = -5,
	UITiOpenChatNativeItemMultiButton = -6,
	UITiOpenChatNativeItemSegmented = -7,
	
	UITiOpenChatNativeItemTextView = -8,
	UITiOpenChatNativeItemTextField = -9,
	UITiOpenChatNativeItemSearchBar = -10,
	
	UITiOpenChatNativeItemPicker = -11,
	UITiOpenChatNativeItemDatePicker = -12,
	
	UITiOpenChatNativeItemInfoLight = -13,
	UITiOpenChatNativeItemInfoDark = -14,
	
	UITiOpenChatNativeItemDisclosure = -15,
	
	UITiOpenChatNativeItemContactAdd = -16
};
...
#endif
/**
 *	TiThreadPerformOnMainThread should replace all TiOpenChat instances of
