...
//@interface TiOpenChatObject : NSObject
//@end

@interface TiOpenChatObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TiOpenChatObject class]])
		{
			for (NSString *key in [[(TiOpenChatObject*)o modules] allKeys])
			{
