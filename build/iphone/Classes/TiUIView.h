...
/**
 Base class for all TiOpenChat views.
 @see TiViewProxy
 */
#ifdef TI_USE_AUTOLAYOUT
...
/**
 Whether or not a view not normally picked up by the TiOpenChat view hierarchy (such as wrapped iOS UIViews) was touched.
