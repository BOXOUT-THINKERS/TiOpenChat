...
@interface TiOpenChatObject : KrollCoverageObject {
#else
@interface TiOpenChatObject : KrollObject {
#endif
@private
...
extern NSString * TiOpenChat$ModuleRequireFormat;
